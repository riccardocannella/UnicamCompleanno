    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                bool prossimoCompleannoQuestAnno = true;
                ...
                if ((dataDiNascita.Month == DateTime.Today.Month && dataDiNascita.Day <= DateTime.Today.Day) || 
                        dataDiNascita.Month < DateTime.Today.Month)
                    prossimoCompleannoQuestAnno = false;
